...
public class Pipes {
    ...
    private final float DISTANCE_BETWEEN_PIPES = 375f;
    ...
    public void movePipes() {
        body1.setLinearVelocity(-3, 0);
        body2.setLinearVelocity(-3, 0);
        body3.setLinearVelocity(-3, 0);
